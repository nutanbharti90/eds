...
export default async function decorate(block) {
  ...
  tabs.forEach((tab, i) => {
    ...
    // restructure the remaining panel cell into image column + text column
    const content = tabpanel.querySelector(':scope > div');
    if (content) {
      content.classList.add('tabs-profile-body');
      const imgP = [...content.children].find((c) => c.querySelector('picture, img'));
